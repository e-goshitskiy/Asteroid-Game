...
window.addEventListener('load',
    function ()
    {
        ...
        PhysicsEngine.prototype.hitAccuracy = 5;

        PhysicsEngine.prototype.items;

        PhysicsEngine.prototype.process = function ()
        {
            ...
            for (let i = 0; i < this.items.length; i++)
            {
                ...
                for (let j = 0; j < this.items.length; j++)
                {
                    ...
                    if (/**/)
                    {
                        item1.onCollideWith(item2);
                        item2.onCollideWith(item1);
                    }
                }
            }
        };
        ...
        //
        let physicsEngine1 = new PhysicsEngine;

        physicsEngine1.items.push({name: 'Asteroid1'});
        ...
        let AbstractElement = function ()
        {
            this.items = [];
        };

        AbstractElement.prototype.items;

        AbstractElement.prototype.defragment = function ()
        {
            for (let i = 0; i < this.items.length; i++)
            {
                if (this.items[i].isDestructed)
        ...
        AbstractElement.prototype.move = function (time)
        {
            this.defragment();
        ...
        AbstractElement.prototype.draw = function ()
        {
            for (let i = 0; i < this.items.length; i++)
            {
        ...
        Asteroids.prototype = new AbstractElement;
        ...
        Explosions.prototype = new AbstractElement;
        ...
        Shells.prototype = new AbstractElement;
        ...
        let shells = new Shells;

        // let shell = new GreenLaser;
        //
        // shells.items.push(shell);
        ...
        function gameOverGameState(time)
        {
            moveAsteroids(tickTime);
            moveSplinter(tickTime);
            movePlayership(tickTime);
